...
Olmo 3 の開発は、**Base Model Training**（基盤モデル訓練）と **Post-training**（後訓練）の 2 つの主要ステージに分かれている。
...
100 億トークンの **Dolma 3 Dolmino Mix** で中間訓練を実施する。このステージの目的は、コード、数学、一般知識 QA などの重要な能力を強化することである。
...
3. **RLVR (Reinforcement Learning with Verifiable Rewards)**: OlmoRL による強化学習
   ...
   > 詳細: [OlmoRL / GRPO](10-olmorl-grpo.qmd)

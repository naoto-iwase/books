...
┌─────────────────────────────────────────────────────────────────────────────┐
│  Stage 1: Pretraining                                                        │
│  - データ: Dolma 3 Mix (6T tokens)                                           │
│  - 目的: 一般的な言語理解・生成能力の獲得                                    │
│  - 特徴: Webテキスト、学術PDF、コードなど多様なソース                        │
└─────────────────────────────────────────────────────────────────────────────┘
                                      ↓
┌─────────────────────────────────────────────────────────────────────────────┐
│  Stage 2: Midtraining                                                        │
│  - データ: Dolma 3 Dolmino Mix (100B tokens)                                │
│  - 目的: Math, Code, QA, Reasoning能力の強化                                │
│  - 特徴: 高品質合成データ + Post-training準備                                │
└─────────────────────────────────────────────────────────────────────────────┘
                                      ↓
┌─────────────────────────────────────────────────────────────────────────────┐
│  Stage 3: Long-context Extension                                             │
│  - データ: Dolma 3 Longmino Mix (50B-100B tokens)                           │
│  - 目的: コンテキスト長を8K→65Kに拡張                                       │
│  - 特徴: olmOCR science PDFs + 合成長文データ                                │
└─────────────────────────────────────────────────────────────────────────────┘
                                      ↓
┌─────────────────────────────────────────────────────────────────────────────┐
│  Post-training (SFT/DPO/RL)                                                  │
│  - Think / Instruct / RL-Zero バリアント                                     │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│ - reasoning patterns の学習                       │
│ - verification/backtracking 行動の獲得            │
│ - 構造化された思考プロセスの内在化                │
└───────────────────────────────────────────────────┘
        ↓
Post-trainingでの発展（SFT → DPO → RL）
        ↓
Olmo 3 Think: 優れたRL軌跡を実現
```
